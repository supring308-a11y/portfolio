...
具体的には、従業員を対象として、業務量、人員配置、業務上の課題などについて匿名アンケートを実施し、残業の多いグループと少ないグループの違いを確認します。
...
そのため、若手・JobLevel 1の従業員に対して、定期的な1on1ミーティングなどを通じて業務負荷やキャリア上の悩みを把握できる仕組みを設け、問題を早期に発見できる体制を検討することが大切だと考えられます。
...
2018年3〜5月は高水準で推移し、6月に減少した後、7月は小幅に回復しました。分析対象の最終注文日時は2018年8月29日であり、8月は月末までのデータが揃っていないため、他の月との単純比較には注意が必要です。
...
2位のRJ（リオデジャネイロ州）の約176万BRLと比較して約2.9倍となっており、SPが売上規模の大きい地域であることが分かりました。
...
総売上だけで地域を評価せず、注文数や1注文あたり売上も含めて地域×商品カテゴリの特徴を把握し、それぞれに適した販売施策を検討することを提案します。
