...
本分析では、IBM HR Analytics Employee Attrition & Performanceデータセットを使用し、従業員の年齢、勤続年数、職位、職種、残業、仕事満足度などの観点から、離職率の傾向を確認しました。

分析の結果、20代、JobLevel 1、残業ありの従業員で離職率が高く、特に20代 × JobLevel 1 × 残業ありのグループでは離職率が67.2%となりました。また、残業ありの従業員は、残業なしと比較して約2.9倍の離職率となっており、JobSatisfactionやJobRoleなど複数の切り口でも、残業ありのグループで高い離職率が確認されました。

一方で、これらの結果は各変数と離職の関連性を示すものであり、残業や職位などが離職の直接的な原因であるとは断定できません。今後は、残業が発生する背景や若手・JobLevel 1の従業員が抱える業務上の課題を調査し、原因に応じた対策を検討する必要があると考えます。
# 離職率の分析
